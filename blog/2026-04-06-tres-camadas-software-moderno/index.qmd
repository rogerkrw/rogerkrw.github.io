...
Com LLMs, esse contrato não existe. Faça a mesma pergunta duas vezes e você obtém respostas diferentes. Ambas podem ser corretas. Ambas podem ser incorretas de formas distintas. A saída não é determinística — é probabilística. E o espaço de saídas possíveis é, na prática, infinito.

Isso cria o que engenheiros de IA descrevem como "os três abismos do desenvolvimento com LLMs": o abismo da compreensão (entre o desenvolvedor e os dados reais de uso), o abismo da especificação (entre o que o desenvolvedor quer que o LLM faça e o que ele efetivamente faz) e o abismo da generalização (entre como o sistema funciona no dataset de teste e como funciona em produção).
...
A adição dos evals como disciplina central não elimina as camadas anteriores — ela se sobrepõe a elas.
...
*Rogério Kreidlow trabalha como Head de Expansão na BeTalent Tech e escreve sobre produto, tecnologia e estratégia.*
